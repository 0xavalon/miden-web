...
const delegatedProver = import.meta.env.VITE_NODE_ENV === 'development' ? `http://18.118.151.210:8082`: "https://http-to-https.vercel.app/proxy?url=http://18.118.151.210:8082";
